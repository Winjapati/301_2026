# 301_2026
Repo for LIN 301, Computation for Linguists, Fall 2026.

## How this repo works

This repo only ever contains the current week's materials — not the whole semester at once. Each week, new slides and homework will be added to the repo and pushed.

**Before each class, pull the repo** to make sure you have the latest files:
