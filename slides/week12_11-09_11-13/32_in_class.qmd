...
doc = nlp("They smacked, slapped, punched, kicked, and attacked the intruder before fleeing.")
...
fox_en = "The quick brown fox jumped over the lazy dog."
fox_fr = "Le rapide renard brun sauta par-dessus le chien paresseux."
fox_es = "El veloz zorro marrón saltó sobre el perro perezoso."
fox_de = "Der flinke braune Fuchs sprang über den faulen Hund."

for lang, nlp, text in [("English", nlp_en, fox_en), ("French", nlp_fr, fox_fr), ("Spanish", nlp_es, fox_es), ("German", nlp_de, fox_de)]:
    doc = nlp(text)
    print(f"\n {lang} Tokens:")
    print([t.text for t in doc])
```
...
df_all = pd.concat([
    lemma_table(nlp_en, fox_en, "English"),
    lemma_table(nlp_fr, fox_fr, "French"),
    lemma_table(nlp_es, fox_es, "Spanish"),
    lemma_table(nlp_de, fox_de, "German")
])
