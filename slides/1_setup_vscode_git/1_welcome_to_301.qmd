...
-   Imagine typing this prompt to an AI assistant:
...
-   By the end of the semester, you'll be able to read every line of this yourself — variables, functions, `pandas`, `spaCy`, visualization — and just as importantly, judge whether it's actually *correct*.
-   We'll come back to this exact script in your last homework.
...
<li>Command Line & File Structure</li>
