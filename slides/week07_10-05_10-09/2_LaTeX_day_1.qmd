...
-   What did we talk about in Monday's class? (Hint: `pandas`, CSVs, and Excel files)

## Wait, Didn't We Just Finish Python?

-   Yes — and that's on purpose.
-   Everything from `pandas` (tables, cleaning, exporting data) is about to become directly useful here.
-   By the end of this unit, you'll take a table you built in `pandas` and turn it into a properly typeset LaTeX table.
...
-   Visit [this site](https://latexref.xyz/Document-class-options.html "https://latexref.xyz/Document-class-options.html") to see what types of options documentclasses can have. Modify your main.tex with these options to experiment.
...
<!--# Need to install packages for ref and figures; didn't get to the end, perhaps combine some slides/activities? -->
