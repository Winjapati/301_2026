...
<!--# These are great for article format, some are dependant on pages having multiple columns, etc. Perhaps just use \pagebreak -->
...
<!--# We didn't get through citations all the way, weren't able to test it. -->
