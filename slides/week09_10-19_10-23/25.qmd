...
<!-- Okay, a lot of the pandas work has methods that are tedious/uninteresting. Need to restructure in a way that's more engaging. -->
...
- Using `.sum()` and basic addition, identify the total number of 
