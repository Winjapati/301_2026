...
- Solved real technical issues: Python installs, spaCy errors, VSCode/environment quirks.
...
<!-- TODO: this whole "Course Evals" section is last year's end-of-semester reflection notes, not new content -- it literally lists "RStudio --> ?" and "LaTeX --> Python --> HTML" as things to change, which is exactly what this 2026 redesign does. Consider replacing this with a fresh reflection slide for the actual 2026 course evals, or cut it if it was only ever a private note-to-self. -->
...
- RStudio → ✅ done (VSCode, 2026)
- LaTeX → Python → HTML → ✅ done (Python moved earlier, LaTeX after Pandas, HTML at the end, 2026)
