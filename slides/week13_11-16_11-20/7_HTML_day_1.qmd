...
-   Create a personal homepage at GitHub Pages, that is a simplified version of [this](https://winjapati.github.io/ "link to Dr. Byrd's webpage")
...
-   To "comment" (`<!--# ... -->`) within VSCode, select the line(s) and press "Ctrl + K, Ctrl + C" or "⌘ + K, ⌘ + C" (uncomment: "Ctrl/⌘ + K, Ctrl/⌘ + U")
...
-   Find the folder in VSCode's Explorer panel that you'd like to create an html file in.
...
-   Right-click "test.html" in VSCode's Explorer and choose "Open with Live Server" (or open it directly in your browser).
    -   What happens?
...
-   Download \<href="7_mock_sita e.html" download\>this `html` file</a> and analyze its code.
-   Identify how to:
    -   <em> emphasize </em> a word
    -   make a word <strong> strong </strong>
