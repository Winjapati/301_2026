...
- Remember `try`/`except` from Conditionals week? This is exactly the kind of task where it earns its keep — wrap your file-reading step in a `try` block so a typo'd filename doesn't crash your whole script.
